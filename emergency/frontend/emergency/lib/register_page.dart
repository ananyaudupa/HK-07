...
class _RegisterState extends State<Register> {
  // Initialize TextEditingController with dummy values
  final TextEditingController _usernameController = TextEditingController(text: 'dummy_username');
  final TextEditingController _phoneController = TextEditingController(text: '918792264759');
  final TextEditingController _cityController = TextEditingController(text: 'dummy_city');
  ...
  void _clearFields() {
    ...
    setState(() {
      _isAmbulanceDriver = false; // Reset the checkbox
    });
  }
